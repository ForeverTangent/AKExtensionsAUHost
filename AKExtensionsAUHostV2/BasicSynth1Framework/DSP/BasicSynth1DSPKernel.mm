...
#import "BasicSynth1DSPKernel.hpp"
#import "BasicSynth1DSPKernelAdapter.h"

@implementation BasicSynth1DSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    BasicSynth1DSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block BasicSynth1DSPKernel *state = &_kernel;
