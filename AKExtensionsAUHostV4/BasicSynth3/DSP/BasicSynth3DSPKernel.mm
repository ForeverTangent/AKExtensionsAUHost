...
#import "BasicSynth3DSPKernel.hpp"
#import "BasicSynth3DSPKernelAdapter.h"

@implementation BasicSynth3DSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    BasicSynth3DSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block BasicSynth3DSPKernel *state = &_kernel;
