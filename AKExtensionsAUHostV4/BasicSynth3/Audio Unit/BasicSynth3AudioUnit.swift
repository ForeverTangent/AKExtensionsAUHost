...
public class BasicSynth3AudioUnit: AUAudioUnit {

    private let parameters: BasicSynth3Parameters
    private let kernelAdapter: BasicSynth3DSPKernelAdapter
    ...
    public override init(componentDescription: AudioComponentDescription,
        ...
        kernelAdapter = BasicSynth3DSPKernelAdapter()

        // Create parameters object to control paramOne
        parameters = BasicSynth3Parameters(kernelAdapter: kernelAdapter)
