...
/// Manages the BasicSynth3 object's paramOne.
class BasicSynth3Parameters {

    private enum BasicSynth3Param: AUParameterAddress {
        case paramOne
    }
    ...
    var paramOne: AUParameter = {
        let parameter =
            AUParameterTree.createParameter(withIdentifier: "paramOne",
                                            name: "paramOne",
                                            address: BasicSynth3Param.paramOne.rawValue,
                                            min: 0.0,
                                            max: 100.0,
                                            unit: .percent,
                                            unitName: nil,
    ...
    init(kernelAdapter: BasicSynth3DSPKernelAdapter) {
        ...
        parameterTree.implementorStringFromValueCallback = { param, value in
            ...
            case BasicSynth3Param.paramOne.rawValue:
