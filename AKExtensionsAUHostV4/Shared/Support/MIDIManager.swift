...
//
//  Based on the original MIDI Manager by Gene De Lisa,
//  Minor Additions and Modification by Stanley Rosenbaum on 2/13/20.
//
...
class MIDIManager {
	...
	static let midiLog = OSLog(subsystem: "MIDIManager", category: "MIDI")
