...
#ifndef AUv3ParameterRamper_h
#define AUv3ParameterRamper_h
...
public:
    AUv3ParameterRamper(float value) : changeCounter(0) {
        setImmediate(value);
    }
